...
import { getLexerFromLineColumnString, TestError } from "../test_running/test_error.js";
...
import { objC, objD, rst, symA, symC, symD, valA, valB } from "../utilities/colors.js";
 ...
 * @param reporter
 */
export async function createInspectionMessage(result: TestResult, test: TestRig, suite: TestSuite, reporter: Reporter, watched_files: Set<string>): Promise<string> {
